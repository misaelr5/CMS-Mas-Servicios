    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              ...
              <p className="mt-1 text-sm text-lightGray/55">Ve todo y administra usuarios.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              <p className="font-semibold">Encargado</p>
              <p className="mt-1 text-sm text-lightGray/55">Opera módulos diarios sin administrar usuarios.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              <p className="font-semibold">Cajero</p>
              <p className="mt-1 text-sm text-lightGray/55">Carga operaciones asignadas.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              <p className="font-semibold">Viewer</p>
              <p className="mt-1 text-sm text-lightGray/55">Solo lectura.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 space-y-3 text-sm text-lightGray/55">
        ...
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 space-y-3">
            {configData.branches.map((branch) => (
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4" key={branch.id}>
                <p className="font-semibold">{branch.name}</p>
                <p className="text-sm text-lightGray/55">Estado: {branch.status}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 space-y-3">
            {configData.cashRegisters.map((cashRegister) => (
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4" key={cashRegister.id}>
                <p className="font-semibold">
                  {cashRegister.register_number ? `Caja ${cashRegister.register_number}` : cashRegister.name} - {cashRegister.name}
                </p>
                <p className="text-sm text-lightGray/55">Sucursal: {cashRegister.branch_name ?? cashRegister.branch_id}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 space-y-3">
            {configData.cashReportCategories.map((category) => (
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4" key={category.id}>
                <p className="font-semibold">{category.name}</p>
                <p className="text-sm text-lightGray/55">Orden: {category.sort_order}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
          ...
          <div className="mt-4 space-y-3">
            {configData.bags.map((bag) => (
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4" key={bag.id}>
                <p className="font-semibold">{bag.name}</p>
                <p className="text-sm text-lightGray/55">Base: {formatArs(Number(bag.base_limit_ars))}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="rounded-3xl border border-border bg-white/[0.06] p-5 text-brandWhite shadow-soft">
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
            <p className="text-sm text-lightGray/55">Fuente de datos</p>
            <p className="font-semibold">{configData.source === "database" ? "Supabase" : "Seeds locales"}</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
            <p className="text-sm text-lightGray/55">Notas internas</p>
            <p className="font-semibold">Preparadas con auditoria</p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
            <p className="text-sm text-lightGray/55">RLS</p>
